...
const BOTNAME = 'VINCE-X';
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '2348069918096' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zQUmRJZA#bQ955M_SMOMB7c_QaPZxmZt57CM3inajJlLsLCWilZU' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "null" : process.env.MODERATORS ,    
